...
static SOC_ENUM_SINGLE_DECL(aiu_codec_ctrl_mux_enum, AIU_CODEC_CLK_DATA_CTRL,
			    CTRL_DATA_SEL_SHIFT,
...
static const struct snd_soc_dapm_widget aiu_codec_ctrl_widgets[] = {
	SND_SOC_DAPM_MUX("CODEC CTRL SRC", SND_SOC_NOPM, 0, 0,
			 &aiu_codec_ctrl_mux),
};

static struct snd_soc_dai_driver aiu_codec_ctrl_dai_drv[] = {
	[CTRL_I2S] = AIU_CODEC_CTRL_INPUT("CODEC I2S IN", 2),
	[CTRL_PCM] = AIU_CODEC_CTRL_INPUT("CODEC PCM IN", 2),
	[CTRL_OUT] = AIU_CODEC_CTRL_OUTPUT("CODEC OUT", 2),
};

static const struct snd_soc_dapm_route aiu_codec_ctrl_routes[] = {
	{ "CODEC CTRL SRC", "I2S", "CODEC I2S IN Playback" },
	{ "CODEC CTRL SRC", "PCM", "CODEC PCM IN Playback" },
	{ "CODEC OUT Capture", NULL, "CODEC CTRL SRC" },
};
