...
struct audin {
	struct clk *pclk;
	struct audin_interface i2s;
	struct audin_interface spdif;
};
...
int audin_hdmi_ctrl_register_component(struct device *dev);
int audin_acodec_ctrl_register_component(struct device *dev);
